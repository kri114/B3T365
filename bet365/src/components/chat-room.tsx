...
/** Deterministic accent colour per username so people are easy to track. */
const COLOURS = ["#7fb5ff", "#3ddc84", "#e3c36b", "#f4a3c1", "#b39ddb", "#7fd8d0", "#f0a868"];
            ...
            return (
              <div key={m.id} className={clsx("group flex flex-col", mine ? "items-end" : "items-start")}>
                <div className="flex items-baseline gap-2">
                  {!mine && (
                    <span className="flex items-center gap-1 text-[11px] font-bold" style={{ color: colourFor(m.username) }}>
