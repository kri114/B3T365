        ...
        {!post && (
          <div className="flex items-center gap-1.5">
            ...
            <Link
              ...
              className="flex items-center gap-0.5 rounded-lg border border-line px-2 py-2 text-[11px] font-semibold text-mute transition-colors hover:border-gold/40 hover:text-gold"
              title="All markets"
            >
              +30
