...
const LINKS = [
  ...
  { href: "/chat", label: "Lounge", icon: MessagesSquare },
          ...
          {user ? (
            <>
              <Link
                href="/wallet"
                className={clsx(
                  "tnum hidden items-center gap-2 rounded-lg border bg-lift px-3 py-1.5 text-[13px] font-bold transition-colors sm:flex",
                  user.balanceCents < 0
                    ? "border-loss/40 text-loss hover:border-loss/70"
                    : "border-gold/25 text-gold hover:border-gold/50",
                )}
              >
                <Wallet size={14} />
